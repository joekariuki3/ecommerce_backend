...
def default_user(user_factory):
    ...
    """
    return user_factory(username="testuser", email="testuser@mail.com", password="password123")
...
def admin_user(user_factory):
    ...
    """
    return user_factory(username="adminuser", email="adminuser@mail.com", password="password123", is_staff=True)
...
def superuser(user_factory):
    ...
    """
    return user_factory(username="superuser", email="superuser@mail.com", password="password123", is_superuser=True)
