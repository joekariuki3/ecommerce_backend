...
class TestProductSearchByName:
    def test_search_product_by_name(
        ...
        product_factory(
            name="Samsung Galaxy S21", price=799.99, category_id=category.id
        )
    ...
    def test_search_product_by_partial_name(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Electronics")
        product_factory(name="Apple iPhone 13", price=999.99, category_id=category.id)
    ...
    def test_search_product_case_insensitive(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Electronics")
        product_factory(name="Apple iPhone 13", price=999.99, category_id=category.id)
    ...
    def test_search_product_multiple_results(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Electronics")
        product_factory(name="Apple iPhone 13", price=999.99, category_id=category.id)
        product_factory(
            name="Apple MacBook Pro", price=1299.99, category_id=category.id
        )
    ...
    def test_search_product_special_characters(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Electronics")
        product_factory(name="Sony WH-1000XM4", price=349.99, category_id=category.id)
        product_factory(
            name="Bose QuietComfort 35 II", price=299.99, category_id=category.id
        )
        product_factory(name="Apple AirPods Pro", price=249.99, category_id=category.id)
    ...
    def test_search_product_empty_query(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Electronics")
        product_factory(name="Apple iPhone 13", price=999.99, category_id=category.id)
    ...
    def test_search_product_whitespace_query(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Electronics")
        product_factory(name="Apple iPhone 13", price=999.99, category_id=category.id)
    ...
    def test_search_product_numeric_query(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Electronics")
    ...
    def test_search_product_unicode_query(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Books")
        product_factory(
            name="Cien años de soledad", price=19.99, category_id=category.id
        )
    ...
    def test_search_product_long_query(
        self, api_client, product_factory, category_factory
    ):
        category = category_factory(name="Books")
        product_factory(
            name="A very long book title that exceeds normal length",
            price=29.99,
        ...
        assert (
            ...
            == "A very long book title that exceeds normal length"
        )
